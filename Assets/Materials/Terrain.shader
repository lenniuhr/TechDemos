Shader "LenniUhr/Terrain"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Materials/TerrainForwardPass.hlsl"
            ENDHLSL
        }
        Pass
        {
            ...
            #include "Assets/Materials/TerrainShadowCasterPass.hlsl"
            ENDHLSL
        }
        Pass
        {
            ...
            #include "Assets/Materials/DepthOnlyPass.hlsl"
            ENDHLSL
        }
        Pass
        {
            ...
            #include "Assets/Materials/DepthNormalsPass.hlsl"
            ENDHLSL
        }
    }
}
